...
op db 2,2 dup(?)
message_print_array db 10,13,"1) Print array$"
message_inverse db 10,13,"2) Inverse$"
message_absolute db 10,13,"3) Absolute$:"
message_square db 10,13,"4) Square$"
message_multiplicate_inverse db 10,13,"5) Multiplicative inverse$"
message_quit db 10,13,"6) Quit$"
message_arithmetic_shift db 10,13,"7) Arithmetic shift (1-right shift, 2-left shift)$"
message_logic_shift db 10,13,"8) Logic shift (1-right shift, 2-left shift)$"
...
start:           
    ...
    main:  
        print_str nl
        print_str message_print_array
        print_str message_inverse
        print_str message_absolute
        print_str message_square
        print_str message_multiplicate_inverse
        print_str message_quit
        print_str message_arithmetic_shift
        print_str message_logic_shift
        print_str msg5
        print_str nl
        get_str op
        ...
        je call_square
        cmp bl,'5' 
        je call_multiplicate_inverse
        cmp bl,'6'
        je exit_main
        cmp bl, '7'
        je call_arithmetic_shift
        cmp bl, '8'
        je call_logic_shift
        ...
        call_square:
            call sqr_all
            jmp main
        call_multiplicate_inverse:
            call mul_inv_all
            jmp main
        call_arithmetic_shift:
